...
import { createVimModeAdapter, StatusBarAdapter, VimModeKeymap } from '~/plugins/vim/editor'
...
export class CodeEditor extends React.Component<any, CodeEditorState> {
  ...
  componentWillUnmount() {
    ...
    this.monaco?.editor.removeAllMarkers(this.editorInstance?.getId() as string)
